...
import szu.vander.remoteproxy.state.HasTenYuanState;
import szu.vander.remoteproxy.state.NoTenYuanState;
import szu.vander.remoteproxy.state.SoldOutState;
import szu.vander.remoteproxy.state.SoldState;
import szu.vander.remoteproxy.state.State;
import szu.vander.remoteproxy.state.WinnerState;
