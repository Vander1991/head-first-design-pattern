...
import szu.vander.impl1.state.HasTenYuanState;
import szu.vander.impl1.state.NoTenYuanState;
import szu.vander.impl1.state.SoldOutState;
import szu.vander.impl1.state.SoldState;
import szu.vander.impl1.state.State;
import szu.vander.impl1.state.WinnerState;
